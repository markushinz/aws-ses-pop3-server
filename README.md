...
```shell
sudo curl -L "https://github.com/markushinz/aws-ses-pop3-server/releases/download/v1.3.2/aws-ses-pop3-server-$(uname -m)-$(uname -s)" -o /usr/local/bin/aws-ses-pop3-server
